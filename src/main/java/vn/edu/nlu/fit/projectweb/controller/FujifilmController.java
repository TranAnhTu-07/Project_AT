...
@WebServlet(name = "FujifilmController", value = "/Fujifilm")
public class FujifilmController extends HttpServlet{
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (cid != null) {
            try {
                ...
                switch (id) {
                    case 16: categoryName = "MÁY ẢNH FUJIFILM COMPACT"; break;
                    case 17: categoryName = "MÁY ẢNH FUJIFILM MIRRORLESS"; break;
                }
        ...
        request.setAttribute("listFujifilm", listProduct);
        request.setAttribute("catName", categoryName);

        // 4. Chuyển hướng sang file hiển thị (Dùng chung 1 file)
        request.getRequestDispatcher("html/fujifilm.jsp").forward(request, response);
    }
