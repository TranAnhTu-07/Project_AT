...
@WebServlet(name = "CanonDSLRController", value = "/CanonDSLR")
public class CanonDSLRController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, java.io.IOException {
        ...
        request.getRequestDispatcher("html/canon-dslr.jsp").forward(request, response);
    }
