...
@WebServlet(name = "NikonController", value = "/Nikon")
public class NikonController extends HttpServlet{
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (cid != null) {
            try {
                ...
                switch (id) {
                    case 14: categoryName = "MÁY ẢNH NIKON COMPACT"; break;
                    case 15: categoryName = "MÁY ẢNH NIKON MIRRORLESS"; break;
                }
        ...
        request.setAttribute("listNikon", listProduct);
        request.setAttribute("catName", categoryName);

        // 4. Chuyển hướng sang file hiển thị (Dùng chung 1 file)
        request.getRequestDispatcher("html/nikon.jsp").forward(request, response);
    }
